...
The results of multi-perturbation experiment are reported in figures \ref{fig:acc-pert}, \ref{fig:acc-non-pert} and \ref{fig:realf}. An amazing fact is the curves of the algorithms we used are basically stable...***
\begin{figure*}
  \centering
